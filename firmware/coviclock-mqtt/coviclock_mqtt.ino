...
// here is a tutorial for set user and password for mosquitto:
// http://www.steves-internet-guide.com/mqtt-username-password-example/
// user and password for MQTT server
#ifdef MQTT_USE_PASSWORD
  const char* mqtt_user="[YOUR-MQTT-USERNAME]";
  const char* mqtt_password="[YOUR-MQTT-PASSWORD]";
#endif
const char* topic_coviclock="coviclock"; // MQTT topic where message will be published
